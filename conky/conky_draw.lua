...
elements = {
    ...
    change_thickness_on_critical = true,
    background_color_critical = 0xFFFFFF,
    background_thickness_critical = 12,
    bar_color_critical = 0xF45F45,
    ...
    {
    kind = 'ring_graph',
    conky_value = 'fs_used_perc /media/Vault',
    center = {x = 320, y = 1095},
    radius = 102,
    graduated = true,
    number_graduation = 100,
